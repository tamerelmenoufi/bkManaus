...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  ...
  <div class="offcanvas-body">
    ...
    <div class="row mb-1">
      <div class="col">
        <a url="src/relatorios/index.php" class="text-decoration-none" data-bs-dismiss="offcanvas" aria-label="Close">
          <i class="fa-regular fa-user col-1"></i> <span class="col-11">Vendas - BkManaus</span>
        </a>
      </div>
    </div>  
    <div class="row mb-1">
      <div class="col">
        <a url="src/ifood/index.php" class="text-decoration-none" data-bs-dismiss="offcanvas" aria-label="Close">
          <i class="fa-regular fa-user col-1"></i> <span class="col-11">Vendas - Ifood</span>
        </a>
      </div>
    </div>  
    ...
    <div class="row mb-1">
      <div class="col">
        <a url="src/estoque/empresas/index.php" class="text-decoration-none" data-bs-dismiss="offcanvas" aria-label="Close">
          <i class="fa-regular fa-user col-1"></i> <span class="col-11">Estoque</span>
        </a>
      </div>
    </div>  
