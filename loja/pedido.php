        ...
        ?>
            <li class="list-group-item" pedido="<?=$d->codigo?>">
                ...
                <div class="mt-2 mb-2 text-center">
                    ...
                    <ul class="list-group">
                        <?php
                        $q = "select a.* from entregadores a where a.situacao = '1' and a.deletado != '1' and a.loja = '{$_POST['loja']}' and (select count(*) from vendas where delivery_detalhes->>'$.deliveryMan.id' = a.codigo) = 0 order by a.nome";
