...
<div class="d-flex justify-content-between legenda">
    <div class="d-flex flex-column justify-content-between w-50">
        <div class="d-flex justify-content-between" style="font-size:12px">
            <div class="ml-3 p-1"><object style="width:10px; height:10px; border-radius:2px;" class="bg-secondary"></object> Pendente</div>
            <div class="ml-3 p-1"><object style="width:10px; height:10px; border-radius:2px;" class="bg-warning"></object> Produção</div>
        </div>
        <div class="d-flex justify-content-between" style="font-size:12px">
