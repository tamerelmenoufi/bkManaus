...
<div class="home_corpo">
    <!-- <div class="row g-0 m-3">
        ...
        <ul class="list-group">
            <?php
            $query = "select a.*, if(a.producao = 'pendente',0,1) as ordem, b.nome, a.delivery_detalhes->>'$.pickupCode' as entrega, a.delivery_detalhes->>'$.returnCode' as retorno from vendas a left join clientes b on a.cliente = b.codigo where /*a.delivery_id = '{$l->mottu}' and*/ a.situacao = 'pago' and loja = '{$_SESSION['bkLoja']}' order by a.producao asc, a.data desc";
            $result = mysqli_query($con, $query);
...
<div class="d-flex justify-content-between legenda">
    <div class="d-flex flex-column justify-content-between w-50">
        <div class="d-flex justify-content-between" style="font-size:12px">
            <div class="p-1"><span style="width:10px; height:10px; border-radius:2px;" class="bg-secondary"></span> Pendente</div>
            <div class="p-1"><span style="width:10px; height:10px; border-radius:2px;" class="bg-warning"></span> Produção</div>
        </div>
        <div class="d-flex justify-content-between" style="font-size:12px">
            <div class="p-1"><span style="width:10px; height:10px; border-radius:2px;" class="bg-info"></span> Entrega</div>
            <div class="p-1"><span style="width:10px; height:10px; border-radius:2px;" class="bg-success"></span> Entregue</div>
        </div>
    </div>
