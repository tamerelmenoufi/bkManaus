        ...
        <div style="position:relative; background:orange;">
            ...
            <div style="position:absolute; left:0, right:0; bottom:30px; top:70px; z-index:10">
                ...
                <div class="d-flex justify-content-center align-items-end">
                    ...
                    <div class="d-flex justify-content-center align-items-end" style="font-size:70px; color:#fff; font-family:FlameBold; margin-top:-25px;">49<p style="font-size:25px; color:#fff; font-family:FlameBold;">99</p></div>
                </div>
            </div>
        </div>
        <?php
