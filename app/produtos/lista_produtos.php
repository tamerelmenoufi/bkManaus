...
?>
    <div class="produto_painel" codigo="<?=$d->codigo?>" style="background-color:<?=(($d->promocao == '1')?'#bd0100':'trasparent')?>">
        ...
        <div class="w-100">
            ...
            <div class="produto_dados">
                <div class="promocao">DE <?=number_format($d->valor,2,",",false)?></div>
                <div class="d-flex justify-content-between w-100" style="color:<?=(($d->promocao == '1')?'#fbdb00':'#f4352b')?>;">
                    <div><h2 class="produto_dados" style="margin-top:5px;"><span style="color:#fbdb00; font-size:12px;"><?=(($d->promocao == '1')?'POR ':false)?></span><?=number_format((($d->promocao == '1')?$d->valor_promocao:$d->valor),2,",",false)?></h2></div>
