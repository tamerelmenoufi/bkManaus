...
while($d = mysqli_fetch_object($result)){
    ...
    if($lista_produtos){
        ...
        $prd = implode("</div><div class='produto_dados' style='color:".(($d->promocao == '1')?'#ffffff':'#000000')."; height:22px; font-family:Uniform; -webkit-line-clamp: 2;'>- ", $prd);
    }
?>
    <div class="combos" codigo = "<?=$d->codigo?>" style="background-color:<?=(($d->promocao == '1')?'#bd0100':'trasparent')?>">
        ...
        <div class="w-100">
            ...
            <div style="height:90px;">
                <div class="produto_dados" style="color:<?=(($d->promocao == '1')?'#ffffff':'#000000')?>; height:22px; font-family:Uniform; -webkit-line-clamp: 2;">- <?=$prd?></div>
            </div>
    ...
    <div class="produto_painel" codigo="<?=$d->codigo?>" style="background-color:<?=(($d->promocao == '1')?'#bd0100':'trasparent')?>">
        ...
        <div class="w-100">
            ...
            <div class="produto_dados" style="height:60px;">
                <div style="color:<?=(($d->promocao == '1')?'#ffffff':'#000000')?>; font-family:Uniform;"><?=$d->descricao?></div>
            </div>
            <div class="produto_dados">
                <?php
                if($d->promocao == '1'){
