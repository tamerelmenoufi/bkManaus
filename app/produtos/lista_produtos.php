    ...
    <div class="produto_painel" codigo="<?=$d->codigo?>" style="background-color:<?=(($d->promocao == '1')?'#bd0100':'trasparent')?>">
        ...
        <div class="w-100">
            ...
            <div class="produto_dados">
                ...
                <h2 style="color:<?=(($d->promocao == '1')?'#fbdb00':'#f4352b')?>;display: flex; justify-content: between; align-items: center; flex-direction: row; width:100%; ">
                    <div><span style="color:#fff; font-size:12px;"><?=(($d->promocao == '1')?'POR ':false)?></span>R$ <?=number_format($d->valor,2,",",false)?></div>
