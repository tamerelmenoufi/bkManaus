...
?>
    <div class="produto_painel" codigo="<?=$dados->codigo?>">
        ...
        <div class="w-100">
            ...
            <div class="produto_dados" editar="<?=$dados->tipo?>" categoria="<?=$pd->categoria?>" codigo="<?=$dados->codigo?>" style="color:#a1a1a1; padding:15px; cursor:pointer;">
            ...
            <div class="produto_botoes d-flex justify-content-between">
                ...
                <div valor>
                    <h2 class="adicionar" valor="<?=$dados->total?>" style="color:#f12a2a; font-size:15px; font-family:FlameBold; ">
