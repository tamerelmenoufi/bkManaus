...
<div class="container">
  ...
  <?php
    ...
    foreach($rClientes as $i => $v){
        ...
        echo "<tr><td>Com Cadastrados</td><td> {$rClientes[$i]}</td><td><div class='progress'><div class='progress-bar progress-bar-striped role='progressbar' style='width: ".c($rTotal[$i], $rClientes[$i])."%' aria-valuenow='".c($rTotal[$i], $rClientes[$i])."' aria-valuemin='0' aria-valuemax='100'></div></div><td></td></tr>";
        echo "<tr><td>Sem Cadastrados</td><td>".($rTotal[$i] - $rClientes[$i])."</td><td><div class='progress'><div class='progress-bar progress-bar-striped role='progressbar' style='width: ".c($rTotal[$i], $rTotal[$i] - $rClientes[$i])."%' aria-valuenow='".c($rTotal[$i], $rTotal[$i] - $rClientes[$i])."' aria-valuemin='0' aria-valuemax='100'></div></div></td></tr>";
        ...
        echo "<tr><td>Acessos</td><td>".($rTotal[$i] - $rVendas[$i])."</td><td><div class='progress'><div class='progress-bar progress-bar-striped role='progressbar' style='width: ".c($rTotal[$i],$rTotal[$i] - $rVendas[$i])."%' aria-valuenow='".c($rTotal[$i],$rTotal[$i] - $rVendas[$i])."' aria-valuemin='0' aria-valuemax='100'></div></div></td></tr>";
        ...
        echo "<tr><td>Fora do Horário</td><td>".($rTotal[$i] - $rHorario[$i])."</td><td><div class='progress'><div class='progress-bar progress-bar-striped role='progressbar' style='width: ".c($rTotal[$i], $rTotal[$i] - $rHorario[$i])."%' aria-valuenow='".c($rTotal[$i], $rTotal[$i] - $rHorario[$i])."' aria-valuemin='0' aria-valuemax='100'></div></div></td></tr>";
