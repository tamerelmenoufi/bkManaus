...
<div class="container">
  ...
  <?php
    ...
    foreach($rClientes as $i => $v){
        ...
        echo "<tr><td>Com Cadastrados</td><td> {$rClientes[$i]}</td><td><div class='progress'><div class='progress-bar progress-bar-striped role='progressbar' style='width: ".c($rTotal, $rClientes)."%' aria-valuenow='".c($rTotal, $rClientes)."' aria-valuemin='0' aria-valuemax='100'></div></div><td></td></tr>";
        echo "<tr><td>Sem Cadastrados</td><td>".($rTotal[$i] - $rClientes[$i])."</td><td><div class='progress'><div class='progress-bar progress-bar-striped role='progressbar' style='width: ".c($rTotal, $rTotal - $rClientes)."%' aria-valuenow='".c($rTotal, $rTotal - $rClientes)."' aria-valuemin='0' aria-valuemax='100'></div></div></td></tr>";
        echo "<tr><td>Carrinho</td><td>".($rVendas[$i])."</td><td><div class='progress'><div class='progress-bar progress-bar-striped role='progressbar' style='width: ".c($rTotal, $rVendas)."%' aria-valuenow='".c($rTotal, $rVendas)."' aria-valuemin='0' aria-valuemax='100'></div></div></td></tr>";
        echo "<tr><td>Acessos</td><td>".($rTotal[$i] - $rVendas[$i])."</td><td><div class='progress'><div class='progress-bar progress-bar-striped role='progressbar' style='width: ".c($rTotal,$rTotal - $rVendas)."%' aria-valuenow='".c($rTotal,$rTotal - $rVendas)."' aria-valuemin='0' aria-valuemax='100'></div></div></td></tr>";
        echo "<tr><td>Horário Atendimento</td><td>".($rHorario[$i])."</td><td><div class='progress'><div class='progress-bar progress-bar-striped role='progressbar' style='width: ".c($rTotal, $rHorario)."%' aria-valuenow='".c($rTotal, $rHorario)."' aria-valuemin='0' aria-valuemax='100'></div></div></td></tr>";
        echo "<tr><td>Fora do Horário</td><td>".($rTotal[$i] - $rHorario[$i])."</td><td><div class='progress'><div class='progress-bar progress-bar-striped role='progressbar' style='width: ".c($rTotal, $rTotal - $rHorario)."%' aria-valuenow='".c($rTotal, $rTotal - $rHorario)."' aria-valuemin='0' aria-valuemax='100'></div></div></td></tr>";
