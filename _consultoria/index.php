...
<div class="container">
  ...
  <?php
    ...
    foreach($rClientes as $i => $v){
        ...
        echo "<tr><td>Com Cadastrados</td><td> {$rClientes[$i]}</td><td><div class='progress'><div class='progress-bar progress-bar-striped role='progressbar' style='width: 10%' aria-valuenow='10' aria-valuemin='0' aria-valuemax='100'></div></div><td></td></tr>";
