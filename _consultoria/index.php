...
<div class="container">
  ...
  <?php
    ...
    foreach($rClientes as $i => $v){
        ...
        echo "<tr class='table-".(($i> 2)?'success':'warning')."'><td>Horário Atendimento</td><td>".($rHorario[$i])."</td><td class='w-100'><div class='progress'><div class='progress-bar progress-bar-striped' role='progressbar' style='width: ".c($rTotal[$i], $rHorario[$i])."%' aria-valuenow='".c($rTotal[$i], $rHorario[$i])."' aria-valuemin='0' aria-valuemax='100'>".c($rTotal[$i], $rHorario[$i])."%</div></div></td></tr>";
        echo "<tr class='table-".(($i> 2)?'success':'warning')."'><td>Fora do Horário</td><td>".($rTotal[$i] - $rHorario[$i])."</td><td class='w-100'><div class='progress'><div class='progress-bar progress-bar-striped bg-danger' role='progressbar' style='width: ".c($rTotal[$i], $rTotal[$i] - $rHorario[$i])."%' aria-valuenow='".c($rTotal[$i], $rTotal[$i] - $rHorario[$i])."' aria-valuemin='0' aria-valuemax='100'>".c($rTotal[$i], $rTotal[$i] - $rHorario[$i])."%</div></div></td></tr>";
